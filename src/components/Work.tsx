      ...
      <section>
        ...
        <Article>
          ...
          <p className="relative pb-10 md:border-b dark:text-gray-200 md:border-gray-300 md:dark:border-gray-400 md:col-span-3 text-[1.7rem] font-sans">
            - Built SetuAgent, an on-call automation bot that diagnoses and resolves production incidents, now adopted beyond the team, with DevOps using it to automate their own workflows.
            <br />
            - Owned two outages end-to-end as on-call POC on the single service every one of Setu's products relies on to authenticate and process transactions, leading the fix and the leadership RCA review for both.
            <br />
            - Resolved a P0 billing failure that had silently created 6.9M duplicate ClickHouse rows, shipping an idempotent, deterministic repair to restore data integrity.
          </p>
        </Article>
